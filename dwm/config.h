...
static const char *upvol[]      = { "/usr/bin/wpctl",   "set-volume", "-l", "1.0",  "@DEFAULT_AUDIO_SINK@", "5%+", NULL };
...
/* tagging */
static const char *tags[] = { "main", "www", "music", "play", "etc" };
...
static const char *browscmd[] = { "thorium-browser", NULL };
static const char *filexcmd[] = { "thunar", NULL };
static const char *musccmd[]  = { "spotify", NULL };
...
static const char *rofircmd[] = { "rofi", "-show", "run", NULL };
static const char *pwrmenu[]  = { "power_menu.sh", NULL };
static const char *calccmd[]  = { "galculator", NULL };
static const char *pavucmd[]  = { "pavucontrol", NULL };
static const char *picomcmd[] = { "toggle_picom.sh", NULL };
